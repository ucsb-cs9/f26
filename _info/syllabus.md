---
title: "Syllabus, CMPSC 9, Fall 2026"
layout: handout
ready: true
---
...
* **Course Web Site**: <https://ucsb-cs9.github.io/f26/>
* **Instructor**:  [Richert Wang](http://www.cs.ucsb.edu/~richert)
   * Email is richert@ucsb.edu, BUT please use [Piazza](https://piazza.com/ucsb/fall2026/cmpsc9) for course related communication.
* **Lecture**: Tu Th 9:30am-10:45am (ILP 2302)
* **TAs**:  {{site.ta_list_full}} (contact via Piazza)
* **Mentors**: {{site.mentors_list}} (contact via Piazza)
* **Lab** (50 minute lab sections): Wednesdays 9am, 10am, 11am, 2pm (SSMS 1301)
* **Office Hours**: See <https://ucsb-cs9.github.io/f26/info/office_hours/>
...
|-----------------------------------------------|---------------------------|
| Academic Integrity Contract (Tuesday 10/6)    | 1 %                       |
| Midterm (Thursday 10/29), 9:30am - 10:45am    | 35 %                      |
| Final (Tuesday 12/8), 8:00am - 10:00am        | 35 %                      |
| iClicker                                      | 5%                        |
| Homeworks                                     | 9 %                       |
| Labs                                          | 15 %                      |
...
* All labs must be submitted by the due date. There will be a 24-hour late window open on Gradescope for each lab unless stated otherwise. Submissions during the late window period will have a **20% (20-point)** deduction from your lab grade. We will only consider your most recent submission.
